        ...
        <div>
            ...
            <div className="project1">About Me</div>
                ...
                <div className="abt">
                    ...
                    from the Integrated Institute of Technology, I am
                    ...
                    <div className="label"><span className="res-name">Name:</span>Dev Sindhwani</div>
                        <div className="label"><span className="res-name">Age:</span>24</div>
                        <div className="label"><span className="res-name">Job:</span>Software Analyst</div>
                        <div className="label"><span className="res-name">Citizenship:</span>India</div>
                        <div className="label"><span className="res-name">Residence:</span>Delhi</div>
                    <div className="label"><span className="res-name">Email:</span>dev16sindh@gmail.com</div>
                    </div>
                </div>
            ...
            <div className="project1">Experience</div>
                <div className="timeline-container">
                    ...
                    <div className="time-info">Developed Automation tool and SASS application!
                        ...
                        Implemented Comment system in our product!
                        Implemented Google Drive authentication and saving files to
                        google drive!
                        Implemented Multi-tenancy Architecture in our product!
                    ...
                    <div className="time-info">Developed database and coded user input frontend.
                        ...
                        and interacted with the client for requirement execution and
                        sometimes gathering.
                        Google Analytics, Youtube, Gmail API Integrations.
                        Worked on Vue JS for creating User friendly UI.</div>
                    ...
                    <div className="time-info">Full-life cycle web development experience using PHP and
                        MYSQL.
                        Regularly checked deployed code for bugs, errors.
                        Coordinated with the team for more understanding and
                        brainstorming of the project knowledge.</div>
            ...
            <div className="project">Skills</div>
                ...
                {/***Coding SKills ***/}
            <div style={{ display: "flex", gap: "20px" }} className="coding-container">
                ...
                <div className="know-container">
                    ...
                    <div className="devlop"> <FontAwesomeIcon icon={faCheck} className="tick" />App Development</div>

                    <div className="devlop"> <FontAwesomeIcon icon={faCheck} className="tick" />Webapp Development</div>

                    <div className="devlop"> <FontAwesomeIcon icon={faCheck} className="tick" />Shopify Development</div>

                    <div className="devlop"> <FontAwesomeIcon icon={faCheck} className="tick" />Database Management</div>

                <div className="devlop"> <FontAwesomeIcon icon={faCheck} className="tick" />User Interface/User Experience</div>
