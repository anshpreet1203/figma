...
const App = () => {
  ...
  <div className="brands-wrapper">
    <img src="/ad.png" alt="logo" className="logos" />
    <img src="/apple.png" alt="logo" className="logos" />
    <img src="/google.png" alt="logo" className="logos"/>
    <img src="/samsung.png" alt="logo" className="logos" />
    <img src="/nike.png" alt="logo" className="logos" />
